...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	/**
	 * 初始化时扫描包并不是使用的这个对象，这个对象是手动扫描包（即调用本类的scan方法）时使用的
	 * 初始化时扫描包 是通过 ConfigurationClassPostProcessor 中的相关方法实现的，
	 * 而这个类的定义是在初始化 AnnotatedBeanDefinitionReader 时加入的，参考本类无参构造
	 * */
	...
	public AnnotationConfigApplicationContext() {
		/** AnnotatedBeanDefinitionReader 添加了6个很关键的 BeanDefinition */

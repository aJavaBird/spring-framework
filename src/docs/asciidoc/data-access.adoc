...
https://castor-data-binding.github.io/castor[Castor web site]. The Spring
...
file. For more information, see https://castor-data-binding.github.io/castor/reference-guides/1.3.3/html-single/index.html#xml.mapping[Castor
XML Mapping].
